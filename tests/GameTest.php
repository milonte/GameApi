...
class GameTest extends ApiTestCase
{
    ...
    public function testGetGame(): void
    {
        ...
        $this->assertSame($game->gameInfos->title, "Title of Game");
    ...
    public function testPostGame(): void
    {
        ...
        $gameInfosIri = $this->findIriBy(GameInfos::class, ['title' => 'Title of Game']);
        $date = date(DATE_W3C);
        ...
        $this->assertEquals($gameInfosIri, $game->gameInfos);
