...
final class Version20211212135220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, cover_id INT DEFAULT NULL, game_data_id INT DEFAULT NULL, platform_id INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', release_date DATE DEFAULT NULL, INDEX IDX_232B318C922726E9 (cover_id), INDEX IDX_232B318CFF0EB3EC (game_data_id), INDEX IDX_232B318CFFE6496F (platform_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE game_data (id INT AUTO_INCREMENT NOT NULL, cover_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_DCF9FBE2922726E9 (cover_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game_data_platform (game_data_id INT NOT NULL, platform_id INT NOT NULL, INDEX IDX_35499784FF0EB3EC (game_data_id), INDEX IDX_35499784FFE6496F (platform_id), PRIMARY KEY(game_data_id, platform_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game_data_developer (game_data_id INT NOT NULL, developer_id INT NOT NULL, INDEX IDX_8394CCDCFF0EB3EC (game_data_id), INDEX IDX_8394CCDC64DD9267 (developer_id), PRIMARY KEY(game_data_id, developer_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game_data_publisher (game_data_id INT NOT NULL, publisher_id INT NOT NULL, INDEX IDX_7A879200FF0EB3EC (game_data_id), INDEX IDX_7A87920040C86FCE (publisher_id), PRIMARY KEY(game_data_id, publisher_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game_data_tag (game_data_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_C11E7FF0FF0EB3EC (game_data_id), INDEX IDX_C11E7FF0BAD26311 (tag_id), PRIMARY KEY(game_data_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318CFF0EB3EC FOREIGN KEY (game_data_id) REFERENCES game_data (id)');
        ...
        $this->addSql('ALTER TABLE game_data ADD CONSTRAINT FK_DCF9FBE2922726E9 FOREIGN KEY (cover_id) REFERENCES cover_object (id)');
        $this->addSql('ALTER TABLE game_data_platform ADD CONSTRAINT FK_35499784FF0EB3EC FOREIGN KEY (game_data_id) REFERENCES game_data (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE game_data_platform ADD CONSTRAINT FK_35499784FFE6496F FOREIGN KEY (platform_id) REFERENCES platform (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE game_data_developer ADD CONSTRAINT FK_8394CCDCFF0EB3EC FOREIGN KEY (game_data_id) REFERENCES game_data (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE game_data_developer ADD CONSTRAINT FK_8394CCDC64DD9267 FOREIGN KEY (developer_id) REFERENCES developer (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE game_data_publisher ADD CONSTRAINT FK_7A879200FF0EB3EC FOREIGN KEY (game_data_id) REFERENCES game_data (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE game_data_publisher ADD CONSTRAINT FK_7A87920040C86FCE FOREIGN KEY (publisher_id) REFERENCES publisher (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE game_data_tag ADD CONSTRAINT FK_C11E7FF0FF0EB3EC FOREIGN KEY (game_data_id) REFERENCES game_data (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE game_data_tag ADD CONSTRAINT FK_C11E7FF0BAD26311 FOREIGN KEY (tag_id) REFERENCES tag (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game_data DROP FOREIGN KEY FK_DCF9FBE2922726E9');
        $this->addSql('ALTER TABLE game_developer DROP FOREIGN KEY FK_B75D4A9864DD9267');
        $this->addSql('ALTER TABLE game_data_developer DROP FOREIGN KEY FK_8394CCDC64DD9267');
        ...
        $this->addSql('ALTER TABLE game_data_platform DROP FOREIGN KEY FK_35499784FF0EB3EC');
        $this->addSql('ALTER TABLE game_data_developer DROP FOREIGN KEY FK_8394CCDCFF0EB3EC');
        $this->addSql('ALTER TABLE game_data_publisher DROP FOREIGN KEY FK_7A879200FF0EB3EC');
        $this->addSql('ALTER TABLE game_data_tag DROP FOREIGN KEY FK_C11E7FF0FF0EB3EC');
        $this->addSql('ALTER TABLE game DROP FOREIGN KEY FK_232B318CFFE6496F');
        $this->addSql('ALTER TABLE game_data_platform DROP FOREIGN KEY FK_35499784FFE6496F');
        $this->addSql('ALTER TABLE game_publisher DROP FOREIGN KEY FK_4E4E144440C86FCE');
        $this->addSql('ALTER TABLE game_data_publisher DROP FOREIGN KEY FK_7A87920040C86FCE');
        $this->addSql('ALTER TABLE game_tag DROP FOREIGN KEY FK_18D3A446BAD26311');
        $this->addSql('ALTER TABLE game_data_tag DROP FOREIGN KEY FK_C11E7FF0BAD26311');
        ...
        $this->addSql('DROP TABLE game_data_platform');
        $this->addSql('DROP TABLE game_data_developer');
        $this->addSql('DROP TABLE game_data_publisher');
        $this->addSql('DROP TABLE game_data_tag');
